...
## User Management
- User Registration: New users can create accounts with unique emails and passwords. After successfully registering, users need to confirm their account creation via email before logging in.
